...
- [x] Implement versioned project and annotation schema, coordinate scaling, validation, import/export, and malformed-project handling.
- [x] Build a local image viewer with upload, zoom, pan, manual component-region annotation, and editable component fields.
